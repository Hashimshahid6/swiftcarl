...
@section('content')
    <div class="row align-items-center">
        <div class="col-md-6">
            <div class="mb-3">
                <h5 class="card-title">Menu List <span class="text-muted fw-normal ms-2">{{(\App\Models\MenuModel::count())}}</span>
            </div>
        </div>
                        ...
                        <table class="table table-nowrap align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="badge bg-success-subtle text-success mb-0">Full Stack
                                            Developer</span></td>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-info-subtle text-info mb-0">Frontend Developer</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-danger-subtle text-danger mb-0">UI/UX Designer</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-primary-subtle text-primary mb-0">Backend
                                            Developer</span></td>
